...
>
  ...
  text-white max-w-5xl">
    ...
    <h1 className="text-3xl sm:text-4xl md:text-6xl lg:text-7xl xl:text-6xl 
    ...
    text-gray-300 max-w-2xl">
      ...
      markets with precision logistics and uncompised quality
      standards.
    </p>
    ...
    gap-4 sm:gap-6">
      ...
      <button className="px-6 sm:px-8 md:px-10 
      py-3 sm:py-4 
    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 sm:gap-8">
      ...
      transition duration-300 p-5 sm:p-6 text-center">
        ...
        <p className="mt-2 text-gray-600 text-xs sm:text-sm">
          Fresh, premium quality onions sourced directly from trusted farms.
        </p>
      </div>
...
<div className="relative py-16 sm:py-20 md:py-28 
...
overflow-hidden px-4 sm:px-6">
  ...
  <div className="relative z-10 max-w-6xl mx-auto text-center">
    ...
    <p className="mt-8 sm:mt-10 md:mt-12 
    text-sm sm:text-base md:text-lg 
    text-blue-800">
